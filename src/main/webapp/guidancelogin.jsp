...
<div class="media" style="height: 90%;">
    <div class="align-self-center mx-auto">
        <div class="container border border-primary rounded shadow" style="height: 30rem; width: 40rem;">
            <div class="row border shadow" style="background-color: rgb(38,185,173); height: 10%;">
            </div>

            <div class="row mt-3">
                <div class="col-3"></div>
                <form class="col-6" action="guidancelogin" method="post">
                    ...
                    <div class="form-row mb-3">
                        <div class="col ">
                            <label>密码</label>
                            <input type="pwd" name="pwd" class="form-control"  placeholder="请输入密码" required>
                        </div>
                    </div>
                    <div class="form-row mb-3">
                        <div class="col">
                            <label>选择导诊类型</label>
                            <select class="custom-select" name="guidancetype"  required>
