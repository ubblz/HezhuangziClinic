...
@WebFilter(filterName = "InfusionFilter")
public class InfusionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        ClinicWorker info = (ClinicWorker)session.getAttribute(DoctorService.INFUSION_DOCTOR);
        if (info!=null){
