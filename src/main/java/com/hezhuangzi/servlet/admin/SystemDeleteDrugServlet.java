...
@WebServlet(name = "SystemDeleteDrugServlet", value = "/SystemDeleteDrugServlet")
public class SystemDeleteDrugServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (dao.systemDeleteDrug(DrugId)>0) {
                result.put("result",1);
            }else{
                result.put("result",2);
            }
