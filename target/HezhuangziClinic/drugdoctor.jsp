    ...
    <div class="row">
        ...
        <div class="col text-right">
            <h2>
                <span>欢迎</span>
                <span>医生</span>
                <label>${sessionScope.drugdoctor.clin_name}</label>
            </h2>
        </div>
        <div class="col text-left">
            <h2>
                <a href="LogoutServlet?type=drugdoctor">
                    ...
                    <div class="container mt-3 mb-3">
                        <div class="row indrug${dop.patientPrescription.regi_id}">
                            ...
                            <input class="form-control col-4 mr-4" type="text" name="" id="registerid"
                                   placeholder="输入挂号单号"
                                   required>
                            <button onclick="confirmDrug('${dop.patientPrescription.regi_id}')" type="button"
                                    class="btn btn-success col-1 mr-4 ml-4">
                                确定
                            </button>
                        </div>
                        <div style="display: none" class="row mt-2  success${dop.patientPrescription.regi_id}">
...
<%--            <button type="button" onclick="confirmDrug('${dop.patientPrescription.regi_id}')">确定</button>--%>
<%--            <--%>
<%--            /div>--%>
<%--            </c:when>--%>
<%--            <c:otherwise>--%>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.result === 1) {
                            ...
                            // $(".indrug" + registerId).append("<p>成功！</p>");
